...
var candleFields = exports.candleFields = ['openTime', 'open', 'high', 'low', 'close', 'volume', 'closeTime', 'quoteAssetVolume', 'trades', 'baseAssetVolume', 'quoteAssetVolume'];
...
var book = function book(payload) {
  return checkParams('book', payload, ['symbol']) && publicCall('/v1/depth', payload).then(function (_ref4) {
...
exports.default = function (opts) {
  ...
  return {
    ...
    dailyStats: function dailyStats(payload) {
      return checkParams('dailyStats', payload, ['symbol']) && publicCall('/v1/ticker/24hr', payload);
    },
